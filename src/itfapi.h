...
VOID itfCtrlBroadcastMessage(MsgPT msg);
VOID itfCtrlMessageHandler(MsgPT msg);

DaqError itfInit(DaqHandleT handle, PCHAR devName, MsgPT msg);
DaqError itfClose(DaqHandleT handle);
DaqError itfExecuteCommand(DaqHandleT handle, daqIOTP sb, ItfCommandCodeT cmdCode);
DaqHandleT itfGetDriverHandle(DaqHandleT handle);
#endif
